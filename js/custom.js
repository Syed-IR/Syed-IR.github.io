$(document).ready(function(){
  ...
  $('#fullpage').fullpage({
    ...
    'navigationTooltips': ['Homery', 'Problem 1', 'Problem 2', 'Problem 3', 'Problem 4',
     'MVP', 'Competitve Advantage', 'Monetization Model' , 'Team', 'End'],
    ...
    'onLeave': function(index, nextIndex, direction){
      ...
      if (index == 5 && direction == 'down'){
         $('.owl-portfolio').trigger('play.owl.autoplay', 2000);
      }
      else if(index == 7 && direction == 'up'){
         $('.owl-portfolio').trigger('play.owl.autoplay', 2000);
      }
      if (index == 6 && direction == 'up'){
        $('.owl-portfolio').trigger('stop.owl.autoplay'); //this is main line to fix it
      }
      ...
      if(index == 7 && direction == 'down'){
         $('.grow').css('animation', 'grow 1s ease-out 1s forwards');
      }
      if(index == 8 && direction == 'down'){
         $('#her').addClass('fadeInLeft');
         $('#him').addClass('fadeInRight');
      }
  ...
  $('.owl-portfolio').trigger('stop.owl.autoplay'); 
